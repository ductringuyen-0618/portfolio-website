    ...
    <div className="space-y-20">
          ...
          <div className="text-center space-y-12 animate-fade-in-up">
            ...
            <div className="space-y-6">
              <div className="inline-flex items-center px-4 py-2 bg-white/80 dark:bg-earth-900/60 backdrop-blur-sm border border-earth-200 dark:border-earth-700 rounded-full shadow-sm">
                <span className="text-sm font-semibold text-earth-700 dark:text-earth-200">Software Engineer</span>
              </div>

              <h1 className="text-6xl font-bold text-earth-800 dark:text-earth-50 mb-6 text-shadow-sm">About Me</h1>

              <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-8 text-earth-600 dark:text-earth-300">
                <div className="flex items-center space-x-3 bg-white/50 dark:bg-earth-900/50 backdrop-blur-sm px-4 py-2 rounded-xl">
                  <MapPin size={20} className="text-earth-600 dark:text-earth-300" />
                  <span className="font-medium">Seattle, WA</span>
                </div>
                <div className="flex items-center space-x-3 bg-white/50 dark:bg-earth-900/50 backdrop-blur-sm px-4 py-2 rounded-xl">
                  <Calendar size={20} className="text-earth-500 dark:text-earth-400" />
                  <span className="font-medium">5+ Years Experience</span>
                </div>
              </div>
            </div>

            <p className="text-xl text-earth-600 dark:text-earth-300 leading-relaxed max-w-4xl mx-auto">
              Software Engineer at <span className="font-semibold text-earth-700 dark:text-earth-200">Triton Digital</span>, specializing in <span className="font-semibold text-earth-800 dark:text-earth-50">enterprise backend systems</span>, <span className="font-semibold text-earth-600 dark:text-earth-300">AI/ML integration</span>, and <span className="font-semibold text-earth-800 dark:text-earth-50">cloud-native architectures</span>. Currently exploring <span className="font-semibold text-green-600">WebLLM applications</span> with advanced <span className="font-semibold text-orange-600">RAG systems</span>, while contributing to production systems.
            </p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-20">
            <div className="inline-flex items-center px-4 py-2 bg-earth-100 dark:bg-earth-800 border border-earth-200 dark:border-earth-700 rounded-full mb-6">
              <span className="text-sm font-semibold text-earth-700 dark:text-earth-200">Professional Journey</span>
            </div>
            <h2 className="text-5xl font-bold text-earth-800 dark:text-earth-50 mb-6 text-shadow-sm">Experience</h2>
            <p className="text-xl text-earth-600 dark:text-earth-300 max-w-3xl mx-auto">My professional journey in software development and system architecture</p>
          </div>
              ...
              <div key={index} className="card-elevated p-10 group hover:scale-105">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                  <div className="space-y-2">
                    <h3 className="text-2xl font-bold text-earth-800 dark:text-earth-50 group-hover:text-earth-600 dark:group-hover:text-earth-300 transition-colors duration-300">{exp.title}</h3>
                    <p className="text-earth-600 dark:text-earth-300 font-semibold text-lg">{exp.company}</p>
                  </div>
                  <div className="flex items-center space-x-2 mt-4 lg:mt-0">
                    <Calendar size={16} className="text-earth-400" />
                    <span className="text-sm font-medium text-earth-500 dark:text-earth-400 bg-earth-50 dark:bg-earth-800/60 px-3 py-1 rounded-full">{exp.period}</span>
                  </div>
                </div>
                <p className="text-earth-600 dark:text-earth-300 leading-relaxed text-lg">{exp.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="section-padding bg-gradient-to-br from-earth-50 to-earth-100/30 dark:from-earth-950 dark:to-earth-900/40">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <div className="inline-flex items-center px-4 py-2 bg-earth-100 dark:bg-earth-800 border border-earth-200 dark:border-earth-700 rounded-full mb-6">
              <span className="text-sm font-semibold text-earth-700 dark:text-earth-200">Technical Expertise</span>
            </div>
            <h2 className="text-5xl font-bold text-earth-800 dark:text-earth-50 mb-6 text-shadow-sm">Skills & Technologies</h2>
            <p className="text-xl text-earth-600 dark:text-earth-300 max-w-3xl mx-auto">Technologies and tools I work with on a daily basis to build robust solutions</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {skills.map((skillGroup) => (
              <div key={skillGroup.category} className="card-elevated p-8 group hover:scale-105">
                <h3 className="text-xl font-bold text-earth-800 dark:text-earth-50 mb-6 group-hover:text-earth-600 dark:group-hover:text-earth-300 transition-colors duration-300">{skillGroup.category}</h3>
                <div className="space-y-3">
                  {skillGroup.items.map((skill) => (
                    <div
                      key={skill}
                      className="px-4 py-3 bg-earth-50 dark:bg-earth-800/60 hover:bg-earth-100 dark:hover:bg-earth-700 text-earth-700 dark:text-earth-200 hover:text-earth-800 dark:hover:text-earth-50 rounded-xl text-sm font-medium transition-all duration-300 transform hover:scale-105 cursor-default"
                    >
                      {skill}
                    </div>
                  ))}
      ...
      <section className="section-padding bg-white dark:bg-earth-900">
        <div className="max-w-6xl mx-auto">
          <div className="text-center space-y-12">
            <div>
              <div className="inline-flex items-center px-4 py-2 bg-green-50 dark:bg-green-950/40 border border-green-200 dark:border-green-800 rounded-full mb-6">
                <span className="text-sm font-semibold text-green-700 dark:text-green-300">Personal Philosophy</span>
              </div>
              <h2 className="text-5xl font-bold text-earth-800 dark:text-earth-50 text-shadow-sm">Beyond Code</h2>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 text-left">
              <div className="card-elevated p-10 group hover:scale-105">
                ...
                <h3 className="text-2xl font-bold text-earth-800 dark:text-earth-50 mb-4 group-hover:text-earth-600 dark:group-hover:text-earth-300 transition-colors duration-300">What drives me</h3>
                <p className="text-earth-600 dark:text-earth-300 leading-relaxed text-lg">
              ...
              <div className="card-elevated p-10 group hover:scale-105">
                ...
                <h3 className="text-2xl font-bold text-earth-800 dark:text-earth-50 mb-4 group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors duration-300">When I'm not coding</h3>
                <p className="text-earth-600 dark:text-earth-300 leading-relaxed text-lg">
